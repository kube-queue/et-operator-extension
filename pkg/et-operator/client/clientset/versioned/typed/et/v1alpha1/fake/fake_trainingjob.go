...
var trainingjobsResource = schema.GroupVersionResource{Group: "et", Version: "v1alpha1", Resource: "trainingjobs"}

var trainingjobsKind = schema.GroupVersionKind{Group: "et", Version: "v1alpha1", Kind: "TrainingJob"}
...
func (c *FakeTrainingJobs) Create(ctx context.Context, trainingJob *v1alpha1.TrainingJob, opts v1.CreateOptions) (result *v1alpha1.TrainingJob, err error) {
	obj, err := c.Fake.
...
func (c *FakeTrainingJobs) Update(ctx context.Context, trainingJob *v1alpha1.TrainingJob, opts v1.UpdateOptions) (result *v1alpha1.TrainingJob, err error) {
	obj, err := c.Fake.
...
func (c *FakeTrainingJobs) UpdateStatus(ctx context.Context, trainingJob *v1alpha1.TrainingJob, opts v1.UpdateOptions) (*v1alpha1.TrainingJob, error) {
	obj, err := c.Fake.
...
func (c *FakeTrainingJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TrainingJob, err error) {
	obj, err := c.Fake.
